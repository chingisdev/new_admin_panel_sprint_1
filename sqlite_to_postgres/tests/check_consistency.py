import pytest
from sqlite_to_postgres.load_data import create_sqlite_connection, create_postgresql_connection
from sqlite_to_postgres.models import Genre, GenreFilmwork, PersonFilmwork, Person, FilmWork
